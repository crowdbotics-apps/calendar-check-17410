"""calendar_check_17410 URL Configuration
...
admin.site.site_header = "Calendar-Check"
admin.site.site_title = "Calendar-Check Admin Portal"
admin.site.index_title = "Calendar-Check Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Calendar-Check API",
        default_version="v1",
        description="API documentation for Calendar-Check App",
    ),
    public=True,
